...
$(document).ready(function() {
	...
	function firstMenuHide(){
		...
		$(".allmenuIn").css({'transition' : 'all 0s ease-in-out','transform' : 'translateX(-280px)'});
	...
	function hideMenu(){
		isMenuOpen = false;
		$('.dim').css("display","none");
		$(".allmenuIn").css({'transition' : 'all 0.2s ease-in-out','transform' : 'translateX(-280px)'});
